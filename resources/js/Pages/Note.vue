...
<template>
    ...
    <div class="hidden sample-styles">
        <a class="hover:underline text-blue-500 dark:text-blue-300"></a>
        <pre class="my-3 py-1 px-2 rounded-sm text-xs font-bold leading-4 bg-sky-900 text-sky-100"></pre>
        <h1 class="my-4 font-extrabold text-4xl text-3xl text-2xl text-xl text-lg text-base text-sm"></h1>
        <blockquote class="px-4 py-1 my-2 ml-1 border-l-2 border-l-slate-500"></blockquote>
    </div>
                ...
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <a href="https://noteplan.co" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                            Powered by NotePlan
                            <img src="/icon.png" class="h-6 ml-2">
                        </a>
                    </div>
                </div>
